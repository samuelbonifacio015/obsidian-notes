...
**Características:**
- Dos variables con signo positivo (x², y²) y una con signo negativo (z²)
- Una hoja conectada
...
**Tipos de Cilindros:**
1. **Cilindro circular:** x² + y² = r² (variable z ausente)
...
- **Región tipo 1, 2, 3:** Clasificación de sólidos según el tipo de proyección
...
**Ejercicio A:** Identificar y graficar la superficie x² + 4y² + 4z² = 16
**Solución:** Dividir por 16: x²/16 + y²/4 + z²/4 = 1 → Elipsoide con a=4, b=2, c=2

**Ejercicio B:** Describir la región dentro del cilindro x² + y² = 4 y entre los planos z = 0 y z = 6
**Solución:** E = {(x, y, z) | x² + y² ≤ 4, 0 ≤ z ≤ 6}

**Ejercicio C:** Encontrar las trazas del hiperboloide x² - y² - z² = 1
**Solución:** 
- Plano xy (z=0): x² - y² = 1 (hipérbola)
- Plano xz (y=0): x² - z² = 1 (hipérbola)
- Plano yz (x=0): -y² - z² = 1 (sin solución real - no hay traza)